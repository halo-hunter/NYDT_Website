...
<div style="width: 95%; display: table; margin: 0 auto">
    ...
    <div style="width: 100%; height: auto; margin-top: -16px; margin-left:15px; margin-right: 15px; background-color: #f8f9fa; color: #000000; ">
        <p style="text-align: left; padding-top: 30px; padding-left: 15px;">Click the link below to change your password:</p>
        <p style="text-align: left; padding-left: 15px;">
            <a href="{{ route('portal->change_password->show', $mail_data['uuid']) }}" target="_blank">{{ route('portal->change_password->show', $mail_data['uuid']) }}</a>
        </p>
        ...
        <p style="text-align: left; padding-bottom: 30px; padding-left: 15px;">
            ...
            <br/>
            <small>
                &bull; Password link is active for 5 minutes
            </small>
        </p>
    </div>
