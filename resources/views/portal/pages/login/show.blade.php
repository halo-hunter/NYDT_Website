                        ...
                        <div class="card-body">
                            <div class="border p-4 rounded">
                                <div class="text-center mb-4">
                                    ...
                                    <p class="mb-0 text-uppercase">Login to your <b class="text-primary"><u>portal</u></b> account</p>
                                </div>
                                <div class="form-body">
                                    @error('credentials_is_incorrect')
                                    <small>
                                        <div class="alert alert-outline-danger shadow-sm alert-dismissible fade show">
                                            <div class="text-danger text-first-letter-capitalize">{{ $message }}</div>
                                    ...
                                    @if(session('password_change_success_message'))
                                        <small>
                                            <div class="alert alert-outline-success shadow-sm alert-dismissible fade show">
                                                <div class="text-success text-first-letter-capitalize">{{ session('password_change_success_message') }}</div>
                                                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                            </div>
                                        </small>
                                    @endif
                                    @if(session('password_has_been_set_success_message'))
                                        <small>
                                            <div class="alert alert-outline-success shadow-sm alert-dismissible fade show">
                                                <div class="text-success text-first-letter-capitalize">{{ session('password_has_been_set_success_message') }}</div>
                                                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                            </div>
                                        </small>
                                    @endif
                                    <form class="row g-4" method="post">
                                        ...
                                        <div class="col-md-6 text-end">	<a href="{{ route('portal->forgot_password->show') }}">Forgot Password ?</a>
                                        </div>
                                        <div class="col-12">
                                            <div class="d-grid">
