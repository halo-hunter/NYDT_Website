                                    ...
                                    <form method="post">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9 text-secondary">
                                                <input type="text" class="form-control" value="{{ \App\Models\User::where('id', $id)->first()->firstname }}" name="firstname" />
                                                @error('firstname')
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9 text-secondary">
                                                <input type="text" class="form-control" value="{{ \App\Models\User::where('id', $id)->first()->lastname }}" name="lastname" />
                                                @error('lastname')
                                                <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9 text-secondary">
                                                <select class="form-select text-capitalize" aria-label="Default select example" name="user_level">
                                                    <option selected disabled>Select</option>
                                                    @foreach(\App\Models\Crm\UserLevel::all() as $user_level)
                                                        <option value="{{ $user_level->user_level_id }}" @if($user_level->user_level_id == \App\Models\User::where('id', $id)->first()->user_level_id) selected @endif>{{ $user_level->user_level_name }}</option>
                                                    @endforeach
                                                </select>
                                                @error('user_level')
                                                <div class="text-danger">{{ $message }}</div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9 text-secondary">
                                                <div class="input-group" id="show_hide_password_2">
                                                    <input type="password" class="form-control border-end-0" placeholder="Enter New Password" name="confirm_password">
                                                    <a href="javascript:;" class="input-group-text bg-transparent"><i class='bx bx-hide'></i></a>
                                                </div>
