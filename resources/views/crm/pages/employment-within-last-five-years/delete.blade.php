                            ...
                            <div class="card p-4">
                                <div class="card-body">
                                    <div class="d-flex flex-column align-items-center text-center text-capitalize">
                                        <div class="mt-3">
                                            <h4>{{ $item->employment_w_l_f_y__name }}</h4>
                                            <p class="text-secondary mb-1">{{ $item->employment_w_l_f_y__address_of_employer }}</p>
                                        </div>
                                        <form method="post" action="{{ route('employment_within_last_five_years->destroy', $item->id) }}">
                                            @method('delete')
                                            @csrf
