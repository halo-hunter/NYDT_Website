                                        ...
                                        <div class="col-12">
                                            ...
                                            <form method="post" enctype="multipart/form-data" autocomplete="off">
                                                    ...
                                                    <div class="col-sm-9 text-secondary">
                                                        <select class="form-select text-capitalize single-select" aria-label="Default select example" name="client">
                                                            ...
                                                            @foreach($clients as $client)
                                                                <option value="{{ $client->id }}" {{ old('client') == $client->id ? 'selected' : (request('client_id') == $client->id ? 'selected' : '') }}>{{ $client->lastname }} {{ $client->firstname }} | +{{ \Illuminate\Support\Str::replace('+', '', $client->phone) }}</option>
                                                            @endforeach
                                                        </select>
                                                ...
                                                <div class="row mb-3">
                                                        ...
                                                        <div class="due-date-container">
                                                            <div class="input-group mb-2 due-date-group">
                                                                <input type="datetime-local"
                                                                       ...
                                                                       value="{{ old('due_date.0') }}" name="due_date[]"/>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-4 text-secondary">
                                                        <div class="due-date-additional-info-container">
                                                            <div class="input-group mb-2 due-date-additional-info-group">
                                                                <input type="text"
                                                                       class="form-control due-date-additional-info-input"
                                                                       value="" name="due_date_additional_info[]"/>
                                                                <button type="button" class="btn btn-primary add-remove-btn rounded ms-2" data-action="add">+</button>
                                                            </div>
                                                        </div>

                                                        @if($errors->has('due_date_due_date_additional_info'))
                                                            <div class="text-danger">{{ $errors->first('due_date_due_date_additional_info') }}</div>
                                                        @endif
                                                    </div>
                                                </div>
