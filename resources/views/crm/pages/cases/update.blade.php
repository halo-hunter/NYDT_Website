                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-8">
                                            ...
                                            @error('cases_updated_successfully')
                                            <small>
                                            ...
                                            @error('todo_task_added_successfully')
                                            <small>
                                                <div class="alert alert-outline-success shadow-sm alert-dismissible fade show">
                                                    <div class="text-success text-capitalize">{{ $message }}</div>
                                                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                            ...
                                            @error('todo_task_completed_successfully')
                                            <small>
                                                <div class="alert alert-outline-success shadow-sm alert-dismissible fade show">
                                                    <div class="text-success text-capitalize">{{ $message }}</div>
                                                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                            ...
                                            @error('entry_date_updated_successfully')
                                            <small>
                                                <div class="alert alert-outline-success shadow-sm alert-dismissible fade show">
                                                    <div class="text-success text-capitalize">{{ $message }}</div>
                                                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                            ...
                                            @error('entry_date_deleted_successfully')
                                            <small>
                                                <div class="alert alert-outline-success shadow-sm alert-dismissible fade show">
                                                    <div class="text-success text-capitalize">{{ $message }}</div>
                                                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                            ...
                                            <form method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-sm-3">
                                                        <h6 class="mb-0 text-capitalize">Client Personal Details:</h6>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-9 text-secondary">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-8">
                                                                <div class="row">
                                                                    <div class="col-12">
                                                                        <b class="text-muted text-capitalize">Last name:</b> <span class="text-dark text-capitalize">{{ $client->lastname }}</span>
                                                                    </div>
                                                                    <div class="col-12 mt-2">
                                                                        <b class="text-muted text-capitalize">First name:</b> <span class="text-dark text-capitalize">{{ $client->firstname }}</span>
                                                                    </div>
                                                                    @if($client->email != null)
                                                                        <div class="col-12 mt-2">
                                                                            <b class="text-muted">Email:</b> <span class="text-dark text-lowercase">{{ $client->email }}</span>
                                                                        </div>
                                                                    @endif
                                                                    <div class="col-12 mt-2">
                                                                        <b class="text-muted text-capitalize">Phone (Primary):</b> <span class="text-dark text-capitalize">{{ \App\Http\Controllers\Crm\GenericController::format_phone_number_to_us_format($client->phone) }}</span>
                                                                    </div>
                                                                    @if($client->phone_secondary != null)
                                                                        <div class="col-12 mt-2">
                                                                            <b class="text-muted text-capitalize">Phone (Secondary):</b> <span class="text-dark text-capitalize">+{{ $client->phone_secondary }}</span>
                                                                        </div>
                                                                    @endif
                                                                    ...
                                                                    @if(count($relation_ids) > 0)
                                                                        ...
                                                                        @foreach($relation_ids as $relation_id)
                                                                            ...
                                                                            @php
                                                                                ...
                                                                                $relation = \App\Models\Crm\Relation::find($relation_id);

                                                                                $rider = $relation->riders()->first();

                                                                            @endphp

                                                                            <div class="col-12 mt-1 mb-1">
                                                                                {{ $relation->name }}: {{ $rider->firstname }} {{ $rider->lastname }}
                                                                            </div>
                                                                    ...
                                                                    <div class="col-12 mt-2">
                                                                        <a href="{{ route('clients->edit', $client->id) }}" target="_blank"><i class="bx bx-edit"></i></a>
                                                                    </div>
                                                                </div>
                                                ...
                                                <div class="row mb-3 d-none">
                                                    ...
                                                    <div class="col-sm-9 text-secondary">
                                                        <input type="number" class="form-control" value="{{ \App\Models\Crm\CaseModel::where('id', $id)->first()->contract_number }}" name="contract_number" />
                                                ...
                                                @if(\App\Models\Crm\CaseModel::where('id', $id)->first()->case_type == 'Immigration')
                                                    <div class="row mb-4">
                                                        <div class="col-sm-3">
                                                            <h6 class="mb-0">EAD clock</h6>
                                                        </div>
                                                        <div class="col-sm-9 text-dark">
                                                            @if(\App\Models\Crm\CaseModel::where('id', $id)->first()->filling_date != null)
                                                                <h6>{{ \Carbon\Carbon::parse(\App\Models\Crm\CaseModel::where('id', $id)->first()->filling_date)->diffInDays() }} day(s)</h6>
                                                            @endif
                                                        </div>
                                                    </div>
                                                @endif
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-9 text-secondary">
                                                        <input type="text" class="form-control" id="customer_class_of_admissions_input_id" value="{{ \App\Models\Crm\CaseModel::where('id', $id)->first()->class_of_admissions }}" name="class_of_admissions" />
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-9 text-secondary">
                                                        <select class="form-select text-capitalize" aria-label="Default select example" name="case_type" id="case_type_select_id">
                                                            ...
                                                            <option value="Immigration" @if(\App\Models\Crm\CaseModel::where('id', $id)->first()->case_type == 'Immigration') selected @endif>Immigration</option>
                                                            <option value="Criminal" @if(\App\Models\Crm\CaseModel::where('id', $id)->first()->case_type == 'Criminal') selected @endif>Criminal</option>
                                                            <option value="Traffic Violations" @if(\App\Models\Crm\CaseModel::where('id', $id)->first()->case_type == 'Traffic Violations') selected @endif>Traffic Violations</option>
                                                            <option value="Family Matter" @if(\App\Models\Crm\CaseModel::where('id', $id)->first()->case_type == 'Family Matter') selected @endif>Family Matter</option>
                                                        </select>
                                                        @error('case_type')
                                                        <div class="text-danger">{{ $message }}</div>
                                                        @enderror
                                                    ...
                                                    <div class="col-sm-9 text-secondary">
                                                        <select class="form-select text-capitalize" aria-label="Default select example" name="case_subtype" id="case_type_select_id">
                                                            ...
                                                            @foreach($case_sub_types as $case_sub_type)
                                                                <option value="{{ $case_sub_type->id }}"  @if(\App\Models\Crm\CaseModel::where('id', $id)->first()->case_subtype == $case_sub_type->id) selected @endif>{{ $case_sub_type->name }}</option>
                                                            @endforeach
                                                        </select>
                                                        @error('case_subtype')
                                                        <div class="text-danger">{{ $message }}</div>
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-9 text-secondary">
                                                        <input type="datetime-local" class="form-control" value="{{ \App\Models\Crm\CaseModel::where('id', $id)->first()->hearing_date }}" name="hearing_date" />
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <h6 class="mb-0">Docket date</h6>
                                                    </div>

                                                    <div class="col-sm-4 text-secondary">

                                                        <h6 class="mb-3 text-capitalize"></h6>
                                                        <input type="date" class="form-control" value="{{ \Illuminate\Support\Carbon::parse(\App\Models\Crm\CaseModel::where('id', $id)->first()->docket_date)->format('Y-m-d') }}" name="docket_date" />
                                                ...
                                                @if(!is_null($case = \App\Models\Crm\CaseModel::find($id)) && !empty($case->due_date))
                                                    <div class="row mb-3">
                                                        <div class="col-sm-3">
                                                            <h6 class="mb-0 text-capitalize">Due Date</h6>
                                                        </div>

                                                        <div class="col-sm-9 text-secondary">
                                                            <div class="due-date-container">
                                                                @php
                                                                    // Decode the saved due dates (array of arrays)
                                                                    $savedDueDates = json_decode($case->due_date, true) ?? [];
                                                                @endphp

                                                                @foreach($savedDueDates as $index => $due)
                                                                    <div class="input-group mb-2 due-date-group">
                                                                        <!-- Due Date Input -->
                                                                        ...
                                                                        <input type="text"
                                                                               class="form-control ms-2 due-date-additional-info-input"
                                                                               value="{{ $due[1] ?? '' }}"
                                                                               name="due_date_additional_info[]"/>

                                                                        <!-- Add/Remove Button -->
                                                                        <button type="button"
                                                                                class="btn {{ $loop->first ? 'btn-primary' : 'btn-danger' }} add-remove-btn rounded ms-2"
                                                                                data-action="{{ $loop->first ? 'add' : 'remove' }}">
                                                                            {{ $loop->first ? '+' : '-' }}
                                                                        </button>
                                                                    </div>
                                                                @endforeach
                                                ...
                                                @else
                                                    <!-- Case where no saved data is found -->
                                                    <div class="row mb-3">
                                                        <div class="col-sm-3">
                                                            <h6 class="mb-0 text-capitalize">Due Date</h6>
                                                        </div>
                                                        ...
                                                        <div class="col-sm-4 text-secondary">
                                                            <div class="due-date-container">
                                                                <div class="input-group mb-2 due-date-group">
                                                                    <!-- Blank Entries for Users to Add -->
                                                                    <input type="datetime-local"
                                                                           class="form-control due-date-input"
                                                                           name="due_date[]"
                                                                           value=""/>
                                                                    <input type="text"
                                                                           ...
                                                                           name="due_date_additional_info[]"
                                                                           value=""/>
                                                                    <button type="button" class="btn btn-primary add-remove-btn rounded ms-2" data-action="add">+</button>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-4 text-secondary">
                                                        <h6 class="mb-3 text-capitalize">Datetime</h6>
                                                        <input type="datetime-local" class="form-control" value="{{ \App\Models\Crm\CaseModel::where('id', $id)->first()->scheduled_biometric_appointment_datetime }}" name="scheduled_biometric_appointment_datetime" />
                                                    ...
                                                    <div class="col-sm-4 text-secondary">
                                                        ...
                                                        <textarea class="form-control" rows="2" name="scheduled_biometric_appointment_address">{{ \App\Models\Crm\CaseModel::where('id', $id)->first()->scheduled_biometric_appointment_address }}</textarea>
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-4 text-secondary">
                                                        ...
                                                        <input type="datetime-local" class="form-control" value="{{ \App\Models\Crm\CaseModel::where('id', $id)->first()->interview_datetime }}" name="interview_datetime" />
                                                    ...
                                                    <div class="col-sm-4 text-secondary">
                                                        <h6 class="mb-3">Address</h6>
                                                        <textarea class="form-control" rows="2" name="interview_address">{{ \App\Models\Crm\CaseModel::where('id', $id)->first()->interview_address }}</textarea>
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-9 text-secondary">
                                                        <input type="date" class="form-control" value="{{ \Carbon\Carbon::parse(\App\Models\Crm\CaseModel::where('id', $id)->first()->filling_date)->format('Y-m-d') }}" name="filling_date" />
                                                ...
                                                <x-crm.includes.entry-date :caseid="$id"/>

                                                <div class="row mb-3">
                                                    <div class="col-sm-3">
                                                        <h6 class="mb-0 text-capitalize">Entry in the USA date</h6>
                                                    </div>
                                                    <div class="col-sm-9 text-secondary">
                                                        <input type="date" class="form-control" value="{{ \Carbon\Carbon::parse(\App\Models\Crm\CaseModel::where('id', $id)->first()->entry_in_the_usa_date)->format('Y-m-d') }}" name="entry_in_the_usa_date" />
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-9 text-secondary">
                                                        <input type="text" class="form-control" value="{{ \App\Models\Crm\CaseModel::where('id', $id)->first()->judge }}" name="judge" />
                                                        @error('judge')
                                                        <div class="text-danger">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                                                    ...
                                                    <div class="col-sm-9 text-secondary">
                                                        <select class="form-select text-capitalize single-select" aria-label="Default select example" name="attorney_id">
                                                            ...
                                                            @foreach(\App\Models\Crm\Attorneys::all() as $attorney)
                                                                <option value="{{ $attorney->id }}" @if(\App\Models\Crm\CaseModel::where('id', $id)->first()->attorney_id == $attorney->id) selected @endif>{{ $attorney->company_name }} ({{ $attorney->firstname }} {{ $attorney->lastname }})</option>
                                                            @endforeach
                                                        </select>
                                                        @error('attorney_id')
                                                        <div class="text-danger">{{ $message }}</div>
                                                    ...
                                                    <div class="col-sm-9 text-secondary">
                                                        <select class="form-select text-capitalize" name="type_of_hearing_id">
                                                            ...
                                                            @foreach(\App\Models\Crm\TypeOfHearing::all() as $type)
                                                                <option value="{{ $type->id }}" @if(\App\Models\Crm\CaseModel::where('id', $id)->first()->type_of_hearing_id == $type->id) selected @endif>{{ $type->hearing_type }}</option>
                                                            @endforeach
                                                        </select>
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-9 text-secondary">
                                                        <input type="number" step=0.01 class="form-control" value="{{ \App\Models\Crm\CaseModel::where('id', $id)->first()->retainer_cost }}" name="retainer_cost" />
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-9 text-secondary">
                                                        <input type="date" class="form-control" value="{{ \App\Models\Crm\CaseModel::where('id', $id)->first()->retainer_date }}" name="retainer_date" />
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-sm-3">
                                                        <h6 class="mb-0 text-capitalize">Total balance</h6>
                                                    </div>
                                                    <div class="col-sm-9 text-secondary">
                                                        <input type="number" step=0.01 class="form-control" value="{{ \App\Models\Crm\CaseModel::where('id', $id)->first()->total_balance }}" name="total_balance" />
                                                        @error('total_balance')
                                                        <div class="text-danger">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-9 text-secondary">
                                                        <input type="number" step=0.01 class="form-control" value="{{ \App\Models\Crm\CaseModel::where('id', $id)->first()->attorney_cost }}" name="attorney_cost" />
                                                        @error('attorney_cost')
                                                        <div class="text-danger">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-9 text-secondary">
                                                        <input type="number" step=0.01 class="form-control" value="{{ \App\Models\Crm\CaseModel::where('id', $id)->first()->dt_paralegal_services }}" name="dt_paralegal_services" />
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-9 text-secondary">
                                                        <input type="number" step=0.01 class="form-control" value="{{ \App\Models\Crm\CaseModel::where('id', $id)->first()->total_paid }}" name="total_paid" />
                                                        @error('total_paid')
                                                        <div class="text-danger">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                                        ...
                                        <div class="col-4">
                                            <div class="row">
                                                <div class="col-12 mb-5">
                                                    <button type="button" class="btn-secondary btn float-end" data-bs-toggle="modal" data-bs-target="#cases_request_documents_button_id"><i class="bx bx-file"></i> Request Documents</button>
                                                </div>
                                                <div class="col-12">
                                                    <h6>Notes</h6>
                                                </div>
                                                <div class="col-12">
                                                    <div class="border border-2 rounded notes_content_block_class">
                                                        <div class="notes_content_inside_block_class">
                                                            <div class="row">
                                                                @forelse(\App\Models\Crm\CaseNote::where('case_id', $id)->orderBy('id', 'desc')->get() as $case_note)
                                                                ...
                                                                @empty
                                                                    <div class="col-12">
                                                                        <p class="text-center mt-5 text-capitalize">Notes not found</p>
                                                                    </div>
                                                                @endforelse
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-12 mt-2">
                                                    <div class="row">
                                                        <form action="{{ route('cases->insert_note', $id) }}" method="post">
                                                            @csrf
                                                            <div class="col-12 mb-2">

                                                                @if($client->email != '')
                                                                    <div class="form-check float-start">
                                                                        <input class="form-check-input" type="checkbox" value="1" id="note_send_email_input_id" name="note_send_email">
                                                                        <label class="form-check-label prevent-select text-capitalize" for="note_send_email_input_id">
                                                                            Send Email
                                                                        </label>
                                                                    </div>
                                                                @endif
                                                                ...
                                                                @if($client->phone != '')
                                                                    <div class="form-check float-start @if($client->email != '') ms-3 @endif">
                                                                        <input class="form-check-input" type="checkbox" value="1" id="note_send_sms_input_id" name="note_send_sms">
                                                                        <label class="form-check-label prevent-select" for="note_send_sms_input_id">
                                                                            Send SMS
                                                                        </label>
                                                                    </div>
                                                                @endif
                                                            ...
                                                            <div class="col-2">
                                                                <div class="d-grid gap-2">
                                                                    <input class="d-none" type="text" value="{{ $client->firstname }}" name="client_firstname">
                                                                    <input class="d-none" type="text" value="{{ $client->email }}" name="client_email">
                                                                    <button type="submit" class="btn-primary btn ms-4 button_loading_animation_notes_class create_note_form_submit_class">Send</button>
                                                                </div>
                                                            </div>
                                                        </form>
                                                    </div>
                                            ...
                                            <div class="row mt-5">
                                                ...
                                                <div class="col-12">
                                                    <div class="border border-2 rounded notes_content_block_class">
                                                        <div class="notes_content_inside_block_class">
                                                            <div class="row">
                                                                @forelse(\App\Models\Crm\InternalCommentVersionTwo::where('case_id', $id)->orderBy('id', 'desc')->get() as $internal_comment)
                                                                    <div class="col-12 bg-light border-bottom border-1">
                                                                        <div class="m-2">
                                                                            <div class="row">
                                                                                <div class="col-12">
                                                                ...
                                                                @empty
                                                                    <div class="col-12">
                                                                        <p class="text-center mt-5 text-capitalize">Comments not found</p>
                                                                    </div>
                                                                @endforelse
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-12 mt-2">
                                                    <div class="row">
                                                        <form action="{{ route('cases->insert_internal_comment', $id) }}" method="post">
                                                            @csrf
                                                            <div class="col-10">
                                            ...
                                            <div class="row mt-5">
                                                ...
                                                <div class="col-12">
                                                    <div class="border border-2 rounded notes_content_block_class">
                                                        <div class="notes_content_inside_block_class">
                                                            <div class="row">
                                                                @forelse(\App\Models\Crm\UploadDocumentVersionTwo::where('case_id', $id)->orderBy('id', 'desc')->get() as $upload_document)
                                                                    <div class="col-12 bg-light border-bottom border-1">
                                                                        <div class="m-2">
                                                                            <div class="row">
                                                                                <div class="col-12">
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="col-1 text-end">
                                                                                            <form action="{{ route('cases->delete_uploaded_document', $id) }}" method="post">
                                                                                                @csrf
                                                                                ...
                                                                                <div class="col-6 text-start mt-1">
                                                                                    ...
                                                                                    @else
                                                                                        <small>Author: {{ \App\Models\Crm\CaseModel::where('id', $upload_document->case_id)->first()->firstname }} {{ \App\Models\Crm\CaseModel::where('id', $upload_document->case_id)->first()->lastname }}</small>
                                                                                    @endif
                                                                                </div>
                                                                                <div class="col-6 text-end mt-1">
                                                                ...
                                                                @empty
                                                                    <div class="col-12">
                                                                        <p class="text-center mt-5 text-capitalize">Documents not found</p>
                                                                    </div>
                                                                @endforelse
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-12 mt-2">
                                                    <div class="row">
                                                        <form action="{{ route('cases->upload_document', $id) }}" method="post" enctype="multipart/form-data">
                                                            @csrf
                                                            <div class="col-10">
                                                                <input type="file"
                                                                ...
                                                                @else
                                                                    <div class="text-muted">Allowed file type: .pdf, .png, .jpg, .jpeg, .doc, .docx <span class="upload_document_reference_text_file_size">Maximum file size must be: 25 mb</span></div>
                                                                @endif
                                                            </div>
                                            ...
                                            {{--TODO: S Todo tasks component--}}
                                            <x-crm.includes.todo-tasks id="{{ $id }}"/>
                                            {{--TODO: E Todo tasks component--}}

                                        </div>
                                        <div class="col-8">
                                            <div class="row ms-1 me-1 mt-3">
                                                <div class="col-12 bg-primary pt-2 pb-2 text-white rounded-top">
                                                    <span class="h6 text-white text-capitalize">Defence asylum</span>
                                                </div>
                                                <div class="col-12 rounded-bottom border-bottom border-start border-end border-primary">
                                                    <form action="{{ route('cases->defence_asylum', $id) }}" method="post" enctype="multipart/form-data">
                                                        @csrf
                                                        @if(\App\Models\Crm\DefenceAsylumVersionTwo::where('case_id', $id)->exists())
                                                            <div class="row mb-3 mt-3">
                                                                ...
                                                                <div class="col-sm-5 text-secondary">
                                                                    ...
                                                                    @else
                                                                        <div class="text-muted">Allowed file type: .pdf, .png, .jpg, .jpeg, .doc, .docx <span class="exists_defence_asylum_reference_text_file_size">Maximum file size must be: 25 mb</span></div>
                                                                    @endif
                                                                </div>
                                                            </div>
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-9 text-secondary">
                                                                    <input type="date" class="form-control" value="{{ \Carbon\Carbon::parse(\App\Models\Crm\DefenceAsylumVersionTwo::where('case_id', $id)->first()->filing_date)->format('Y-m-d') }}" name="da_filing_date" />
                                                        ...
                                                        @else
                                                            <div class="row mb-3 mt-3">
                                                                <div class="col-sm-3">
                                                                    <h6 class="mb-0 text-capitalize">Upload a form</h6>
                                                                </div>
                                                                <div class="col-sm-9 text-secondary">
                                                                    <input type="file"
                                                                           class="form-control upload_a_form"
                                                                    ...
                                                                    @else
{{--                                                                        <div class="text-muted">Required</div>--}}
                                                                        <div class="text-muted">Allowed file type: .pdf, .png, .jpg, .jpeg, .doc, .docx <span class="not_exists_defence_asylum_reference_text_file_size">Maximum file size must be: 25 mb</span></div>
                                                                    @endif
                                                                </div>
                                                            </div>
                                                            <div class="row mb-3">
...
{{--                                                                        <div class="text-muted">Required</div>--}}
                                                    ...
                                                    <div class="row mt-2 mb-2">
                                                        ...
                                                        <div class="col-12 mt-3">
                                                            <table id="customer_paymant_history_table_id" class="table table-striped" style="width:100%">
                                                                ...
                                                                @empty
                                                                    <tr>
                                                                        <td colspan="10" class="text-center">Payments not found</td>
                                                                    </tr>
                                                                @endforelse
                                ...
                                <div class="col-6">
                                    <div class="mb-3">
                                        ...
                                        <input
                                            type="number"
                                            class="form-control form-control-sm"
                                            value="{{ \App\Models\Crm\CaseModel::where('id', $id)->first()->id }}"
                                            disabled
    ...
    <x-crm.includes.request-documents-modal :client="$client"/>
</div>
<!--end wrapper-->
