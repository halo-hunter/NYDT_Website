                                ...
                                <div class="card-body">
                                    ...
                                    <form method="post">
                                            ...
                                            <div class="col-sm-9 text-secondary">
                                                <select class="form-select text-capitalize single-select" aria-label="Default select example" name="company_address_state_code">
                                                    ...
                                                    @foreach(\App\Models\Crm\States::all() as $state)
                                                        <option value="{{ $state->state_code }}" @if(old('company_address_state_code') == $state->state_code) selected @endif>{{ $state->state_name }}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9 text-secondary">
                                                <input type="text" class="form-control" value="{{ old('company_address_city') }}" name="company_address_city" />
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9 text-secondary">
                                                <input type="text" class="form-control" value="{{ old('company_address_zip_code') }}" name="company_address_zip_code" />
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9 text-secondary">
                                                <input type="text" class="form-control" value="{{ old('company_address_unit') }}" name="company_address_unit" />
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9 text-secondary">
                                                <input type="text" class="form-control" value="{{ old('company_address_address') }}" name="company_address_address" />
