<div class="topbar d-flex align-items-center">
    <nav class="navbar navbar-expand">
        <div class="topbar-logo-header">
            <div class="">
                <a href="{{ route('dashboard') }}"><h4 class="logo-text text-uppercase">{{ config('app.company_short_name') }}</h4></a>
            </div>
        </div>
                            ...
                            <a class="dropdown-item" href="javascript:;">
                                <div class="d-flex align-items-center">
                                    <div class="user-online">
                                        <img src="{{ asset('custom-sources/rukada/assets/images/avatars/avatar-1.png') }}" class="msg-avatar" alt="user avatar">
                                    </div>
